		...
		<el-row class="loading_con">
			...
			<el-col :xs={span:24} :sm={span:11} :md="10" :lg="9" :xl="8">
				<div class="show_json_outer">
					...
					<div id="show_json" v-show="showJson.plate_no">
						<p>车牌：{{showJson.plate_no}}</p>
					</div>
				</div>
			</el-col>
		</el-row>
    ...
    export default {
        ...
        mounted:function () {
            ...
            this.intervalid1 = setTimeout(() => {
                ...
                this.isCheck = false;
                this.dialogImageUrl =this.imgApi+ "/media/photos/cf403d09673f4dfabb656ccf79c5a5a9_drawed.png";
                setTimeout(()=>{
                    loading.close();
                },1000)
            }, 2000);
        ...
        methods: {
            uploadImage(e){
                ...
                formData.append('channel_id', 12);
                $.ajax({
                    url: this.api+"/api/v1/ocr/get_plate_ocr/",
                    type: "post",
                    data: formData,
