...
class CarPlateIdentity:
    ...
    def horizontal_cut_chars(self, plate):
        ...
        for i in range(img_w):
            colValue = self.getColSum(plate,i)
    ...
    def get_chars(self, car_plate):
        ...
        for i,addr in enumerate(char_addr_list):
            ...
            char_img = cv2.resize(char_img,(self.char_w,self.char_h))
    ...
    def car_plate_identity(self, car_path):
        ...
        # cv2.imwrite(temp_folder + 'cnn_plate.png', car_plate)
